...
class JinTanaka2023ForCRPD(BaseAlgorithm):
    """Jin & Tanaka (2023) IDBB exact solver bound to CRP-D."""

    name                = "Jin & Tanaka (2023) IDBB [CRP-D]"
    category            = "Exact"
    description         = (
    ...
    def _run_solver(
        ...
        with tempfile.NamedTemporaryFile(
            mode="w", suffix=".jin_crpd", delete=False, encoding="utf-8"
        ) as tf:
