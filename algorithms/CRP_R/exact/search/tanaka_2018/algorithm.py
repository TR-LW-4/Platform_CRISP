...
class Tanaka2018BB(BaseAlgorithm):
    ...
    def _run_bb(self, instance_text: str, max_tiers: int, time_limit_sec: int) -> Tuple[int, bool, str]:
        ...
        if not binary.is_file():
            raise FileNotFoundError(
                ...
                "Run `make` in vendor/restricted-distinct-1.11 or set "
                "`tanaka2018_binary` / env `TANAKA2018_BRP_BB`."
            )
    ...
    def train(self, problem_factory: Callable, result_queue: mp.Queue, stop_event: mp.Event) -> None:
        ...
        for seed in range(n_seeds):
            ...
            trace_layout(f"Tanaka2018BB.train: seed {seed + 1}/{n_seeds}")
    ...
    def config_schema(cls) -> Dict[str, Any]:
        ...
        base.update({
            ...
            "tanaka2018_binary": {
                ...
                "help": "Leave empty to use bundled vendor binary.",
            },
        })
        return base
