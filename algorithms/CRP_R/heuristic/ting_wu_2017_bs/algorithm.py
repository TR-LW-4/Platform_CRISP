...
-----------------
  ...
  num_eval_seeds : int   — 1 (algorithm is deterministic; set >1 only if
    ...
    def config_schema(cls) -> Dict:
        ...
        base.update({
            "num_eval_seeds": {
                ...
                "help": (
                    "BS is deterministic — 1 seed is sufficient for fixed benchmark "
                    "files.  Use >1 only for random-layout mode."
                ),
            },
            "beam_width": {
                "type":    "int",
